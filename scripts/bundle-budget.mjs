...
const worker=bytes("cloudflare/src/worker.js"),html=bytes("public/index.html"),workspaceRuntime=bytes("public/js/workspace-runtime-20260921a.js"),workspaceStyles=bytes("public/assets/workspace-inline-styles-20260921a.css");
const htmlText=html.toString("utf8"),runtimeText=workspaceRuntime.toString("utf8"),stylesText=workspaceStyles.toString("utf8");
...
const deployedHtmlText=deployedHead+runtimeTail;

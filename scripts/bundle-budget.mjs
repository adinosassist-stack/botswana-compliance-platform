...
const worker=bytes("cloudflare/src/worker.js"),html=bytes("public/index.html"),workspaceRuntime=bytes("public/js/workspace-runtime-20260923g.js"),workspaceStyles=bytes("public/assets/workspace-inline-styles-20260921a.css"),workspaceViews=bytes("public/assets/workspace-view-fragments-20260923f.json");
...
const runtimeExternalizedHtml=htmlText.replace(/<script id="thebe-workspace-runtime-inline">[\s\S]*?<\/script>/,'<script id="thebe-workspace-runtime" src="/js/workspace-runtime-20260923g.js"></script>');

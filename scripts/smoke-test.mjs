...
const required=['authGate','async function bootstrap()','/api/state','/api/evidence/presign','Security Center','function renderSourceRegistry()','function renderPublishing()','hideAuth();void loadBilling();logEvent("APP_OPENED"'];

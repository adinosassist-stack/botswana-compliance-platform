...
assert.match(source,/btn=>btn\.addEventListener\("click",\(\)=>\{syncMobileActive\(btn\.dataset\.view\);if\(isMobile\(\)\)closeMobileWorkspaceMenu\(\)\}\)/,"product source must continue auto-closing the drawer from sidebar navigation");

...
ok(personalizationJs.includes('const RELEASE="20260926-v161"') && personalizationJs.includes('Management priority today') && personalizationJs.includes('Your priority today'),'personalization gives owner and manager role-aware daily-priority framing');
...
ok(productionEntry.includes('OWNER_COMMAND_CENTRE_RELEASE="20260926-v161"') && productionEntry.includes('EXECUTIVE_PERSONALIZATION_RELEASE="20260926-v161"'),'production entry rotates the owner-brief and personalization cache versions together');

...
for(const name of ["test:finance-finalization-sql-abort","test:finance-watch-catchup","test:system-actor-provenance","test:fresh-bootstrap-smoke","test:finance-watch-finalization-integrity","test:finance-watch-cadence-contract","test:finance-finalization-rollback-runtime","test:finance-watch-recovery-finalization","test:finance-watch-owner-attention","test:d1-runtime-parity","test:finance-watch-audit-schema","test:finance-watch-dead-code","test:finance-watch-task-isolation","test:agentic-readiness-migration-tip","test:cloudflare-migration-tip-coherence","test:agent-control-plane","test:agent-control-plane-d1","test:production-agent-control-plane-migration"])assert.ok(stack.includes(name),`protected Finance Watch stack missing ${name}`);

...
assert.ok(production.includes('const WORKSPACE_RUNTIME_ASSET="/js/workspace-runtime-20260923g.js";'),"workspace runtime identity must rotate with injected runtime behavior");

...
assert.ok(production.includes('const WORKSPACE_RESIDENT_VIEW_IDS=Object.freeze(["dashboard","moneyhub","workhub","sites","peopleops","businesshub","obligations","evidencehub","automationhub"]);'),"production resident inventory must keep Money resident while Protect is lazy");
...
assert.ok(production.includes('const WORKSPACE_RUNTIME_ASSET="/js/workspace-runtime-20260926b.js";'),"workspace runtime identity must rotate with injected runtime behavior");

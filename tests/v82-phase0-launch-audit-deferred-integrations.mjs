...
ok(workspaceHtml.includes("root=document.querySelector('#mainContent .view.active')")&&workspaceHtml.includes('root=document.querySelector("#mainContent .view.active")')&&!workspaceHtml.includes('setTimeout(()=>stabilizeWorkspaceTables(document.getElementById(\'mainContent\')||document),30)'), 'post-render table enhancement is scoped to the active/requested view instead of all hidden workspace views');

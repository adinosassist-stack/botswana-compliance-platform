...
ok(productionDeploy.includes('actions/download-artifact@3e5f45b2cfb9172054b4087a40e8e0b5a5461e7c')&&productionDeploy.includes('name: bf07-sealed-${{ env.TARGET_SHA }}')&&productionDeploy.includes('run-id: ${{ steps.qualification.outputs.bf07_run_id }}')&&productionDeploy.includes('bf07_run_id=${bf07RunId}'), 'production automation restores sealed BF-07 evidence from the exact qualified workflow run');

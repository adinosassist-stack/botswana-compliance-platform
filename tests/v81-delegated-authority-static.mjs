...
const migrationWorkflowPath=".github/workflows/migrate-production-v81-delegated-authority.yml";
assert.equal(fs.existsSync(migrationWorkflowPath),false,"completed migration 047 production trigger must remain retired");

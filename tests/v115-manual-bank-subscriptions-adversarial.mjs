...
const checks=[
 ...
 ["migration 050 retained under current release tip",profile.latest_cloudflare_migration==="052_v122_agent_observation_checkpoints.sql"&&m.includes("manual_payment_submissions")],

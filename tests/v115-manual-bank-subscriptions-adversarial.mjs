...
const checks=[
 ...
 ["bank config env",e.includes("THEBE_BANK_NAME=")&&e.includes("THEBE_BANK_ACCOUNT_NUMBER=")&&e.includes("THEBE_BANK_ACCOUNT_NAME=")&&e.includes("THEBE_BANK_BRANCH_NAME=")&&e.includes("THEBE_BANK_SWIFT_CODE=")],
 ...
 ["customer UI bank details",h.includes("Manual bank transfer")&&h.includes("I have paid")&&h.includes("manualBankReference")&&h.includes("<b>Branch:</b>")&&h.includes("<b>SWIFT:</b>")],

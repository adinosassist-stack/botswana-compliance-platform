...
execFileSync(process.execPath,["--check","public/js/workspace-runtime-20260921a.js"],{stdio:"pipe"});
...
assert.match(production,/const WORKSPACE_RUNTIME_ASSET="\/js\/workspace-runtime-20260921a\.js"/);
assert.match(production,/function externalizeWorkspaceRuntime\(html\)/);
assert.match(production,/thebe-workspace-runtime-inline/);
assert.match(production,/surfaceHtml=workspaceSurface\?externalizeWorkspaceRuntime\(baseHtml\):baseHtml/);
...
assert.match(budget,/deployedHtml\.length<650_000/);

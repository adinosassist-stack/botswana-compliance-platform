...
const runtime=fs.readFileSync("public/js/workspace-runtime-20260923b.js","utf8");
...
execFileSync(process.execPath,["--check","public/js/workspace-runtime-20260923b.js"],{stdio:"pipe"});
...
assert.match(production,/const WORKSPACE_RUNTIME_ASSET="\/js\/workspace-runtime-20260923b\.js"/);

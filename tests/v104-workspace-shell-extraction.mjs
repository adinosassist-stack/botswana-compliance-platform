...
execFileSync(process.execPath,["--check","public/js/workspace-runtime-20260926b.js"],{stdio:"pipe"});
...
assert.match(production,/const WORKSPACE_RUNTIME_ASSET="\/js\/workspace-runtime-20260926b\.js"/);
assert.match(production,/const WORKSPACE_STYLES_ASSET="\/assets\/workspace-inline-styles-20260926b\.css"/);

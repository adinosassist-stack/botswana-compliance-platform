...
execFileSync(process.execPath,["--check","public/js/workspace-runtime-20260923e.js"],{stdio:"pipe"});
...
assert.match(production,/const WORKSPACE_RUNTIME_ASSET="\/js\/workspace-runtime-20260923e\.js"/);

...
const syntax=spawnSync(process.execPath,["--check","public/js/workspace-runtime-20260923d.js"],{encoding:"utf8"});
...
assert.match(production,/WORKSPACE_RUNTIME_ASSET="\/js\/workspace-runtime-20260923d\.js"/);

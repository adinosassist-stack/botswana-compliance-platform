...
const checks=[
 ...
 ["daily ops entitlement",w.includes('url.pathname.startsWith("/api/daily-reporting/")')&&w.includes('url.pathname==="/api/daily-reporting/locations"?"operating_locations":"daily_operations"')&&w.includes("requireEntitlement(env,a.tenant_id,featureKey)")],

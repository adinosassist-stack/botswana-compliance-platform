...
assert.match(production,/surfaceHtml=workspaceSurface\?externalizeWorkspaceHeadStyles\(externalizeWorkspaceRuntime\(baseHtml\)\):baseHtml/,"workspace surface must externalize runtime then canonical head styles before asset injection");

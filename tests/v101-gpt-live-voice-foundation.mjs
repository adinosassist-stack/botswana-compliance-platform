...
assert.match(production,/surfaceHtml=workspaceSurface\?externalizeWorkspaceRuntime\(baseHtml\):baseHtml/,"workspace surface must externalize the dominant runtime before asset injection");

...
assert.match(production,/const WORKSPACE_STYLES_ASSET="\/assets\/workspace-inline-styles-20260926a\.css"/,"workspace style extraction must stay versioned and first-party");

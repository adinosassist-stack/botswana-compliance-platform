...
assert.match(src,/claimChanges=Number\(batchResults\?\.\[6\]/,"claim row-count guard must read batch result index 6");
assert.match(src,/taskChanges=Number\(batchResults\?\.\[7\]/,"task row-count guard must read batch result index 7");

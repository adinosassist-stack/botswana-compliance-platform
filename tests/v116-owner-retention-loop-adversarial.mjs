...
assert.match(html,/id="ownerBriefNotice"/);
assert.match(html,/Your operating brief:/);
...
assert.match(daily,/ownerBriefLastGoodAt/);
assert.match(daily,/Thebe Brief · stale/);
assert.match(daily,/last confirmed; refresh failed/);
assert.match(daily,/The last confirmed operating brief remains visible/);

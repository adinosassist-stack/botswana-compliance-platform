...
ok('service worker cache is rotated beyond the prior registration hotfix generation',sw.includes('mobile-startup-recovery-20260915')&&!sw.includes('registration-owner-ui-hotfix-20260914'));

...
ok(Number(String(profile.latest_cloudflare_migration||'').slice(0,3))>=48,'release profile preserves bounded internal-task migration 048 while allowing reviewed successors');

...
ok(worker.includes(`const APP_RELEASE="v78.${pkg.version}"`)&&routeAudit.includes(`release:"${pkg.version}"`)&&(historicalServiceWorker||retiredServiceWorker),"Worker, service worker and route inventory must align to v1.21.51 or reviewed successor");

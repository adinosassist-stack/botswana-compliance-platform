...
const fetchStart=worker.indexOf("async fetch("),gate=worker.indexOf('if(url.pathname.startsWith("/api/"))',fetchStart);ok(fetchStart>0&&gate>fetchStart,"central API gate must exist inside Worker fetch");

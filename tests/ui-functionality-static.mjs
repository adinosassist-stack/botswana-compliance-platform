...
assert.match(html,/aria-label="Open reporting access for \$\{escapeHtml\(e\.full_name\)\}"[^>]*data-bw-onclick="openEmployeeReportingAccess\('/,"employee name\/row must open reporting access directly");

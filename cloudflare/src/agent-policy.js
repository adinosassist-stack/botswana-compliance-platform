...
export const THEBE_AGENTS = Object.freeze({
  thebe: Object.freeze({
    ...
    allowedRoles:Object.freeze(["owner","manager","reviewer","system_observer"])
  })
});
...
export const AGENT_ACTION_CATALOG = Object.freeze({
  ...
  __proto__: null,
  "business_health.read": action({key:"business_health.read",level:AGENT_ACTION_LEVELS.READ,roles:["owner","manager","system_observer"],description:"Read governed business-health indicators and recorded risks.",phase1Enabled:true,capability:"core",legacyAgents:["management"],authoritativeSource:"business_graph_and_deterministic_metrics"}),

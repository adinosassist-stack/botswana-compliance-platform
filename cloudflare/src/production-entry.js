...
const OWNER_COMMAND_CENTRE_RELEASE="20260926-v161";
const EXECUTIVE_PERSONALIZATION_RELEASE="20260926-v161";
const BUSINESS_DATA_BRIDGE_RELEASE="20260913d";
const THEBE_LIVE_VOICE_RELEASE="20260926-blue-v162";
const THEBE_PUBLIC_API_CLIENT_RELEASE="20260920a";
const THEBE_AI_DOCK_RELEASE="20260926-blue-v162";

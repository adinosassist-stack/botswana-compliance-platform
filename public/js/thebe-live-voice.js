(function(global){
  ...
  async function handleFunctionCall(item){
    ...
    try{
      ...
      showStatus("Thebe is checking your business data…");
      ...
      rememberError(error?.message||"The governed Thebe backend could not complete that request.","delegation");
    }finally{
  ...
  function handleServerEvent(raw){
    ...
    if(event.type==="input_audio_buffer.speech_stopped"&&state==="connected"){
      showStatus("Thinking…");
    }
